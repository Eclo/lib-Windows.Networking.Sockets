...
if ($env:APPVEYOR_REPO_TAG -eq "true")
{
    ...
    # new branch name
    $newBranch = "$env:APPVEYOR_REPO_BRANCH-nfbot/update-version/Windows.Networking.Sockets/$env:MyNuGetVersion"
    ...
    {
        $commitMessage = "Update Windows.Networking.Sockets version to $env:MyNuGetVersion"
